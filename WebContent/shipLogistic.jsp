...
// 		                }
						...
						orderNos = orderNos.slice(0, -1);
						
		                $.ajax({
		                    url: 'ship.do',
		                    type: 'post',
		                    data: {
		                        action: 'sendToTelegraphGroup',
		                        order_nos: orderNos
		                    },
		                    error: function(xhr) {},
...
// 		                }
		                ...
		                $.ajax({
		                    ...
		                    type: 'post',
		                    data: {
		                        action: 'sendToCancelSaleOrderServiceGroup',
		                        orderNos: orderNos
		                    },
		                    error: function(xhr) {},
		                    success: function(response) {
...
// 		                }
		                ...
		                $.ajax({
		                    ...
		                    type: 'post',
		                    data: {
		                        action: 'saleOrderOutboundDetailQueryServiceGroup',
		                        orderNos: orderNos
		                    },
		                    error: function(xhr) {},
		                    success: function(response) {
