...
//                 	Console.log("更新某資料");
    ...
    <script>
    $(function(){
    	$("body").append('<a onclick="if(confirm(\'連絡客服將導致討論區中斷\\n　　　　是否繼續？\')){window.location.href=\'sip:<benchen@pershing.com.tw>\';}else{}" class="btn-explanation" style="position: fixed; top: 85%; right: 60px; background-color: white; border-radius: 200px; display: block;"><img src="./images/skype-icon.png"/></a>');
